...
// greet("Yashu"); // Output: Hello Yashu
...
// let base=5;
// let exponent=2;
// const number=power(base,exponent);
// console.log(number)
...
// const calculate=(p,r,t)=>(p*r*t)/100;
// const p=50000;
// const r=5;
// const t=2;
// const ans=calculate(p,r,t)
// console.log(ans);
...
// const checkCase = char =>char === char.toUpperCase()? 'Uppercase': 'Lowercase';
...
// const number=n=>n>0? "Positive":  n<0 ? "Negative"  : " Zero";
