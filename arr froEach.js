...
// doctors.forEach(name => {console.log(`Syncing profile for ${name}`); 
// });
...
// ];
// reminders.forEach(r => console.log(`name: ${r.name},  medicine ${r.medicine}`));
...
//   if (e.late)
//   {
//       console.log(e.name +" you fees is panding "); 
// }
...
//   console.log(`Order ${order.id} logged. Value: ₹${order.value}`)
// );
